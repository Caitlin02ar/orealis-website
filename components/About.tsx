...
export default function About() {
  return (
    <section className="relative bg-[var(--color-dark)] flex flex-col items-center justify-center overflow-hidden min-h-screen">
      <div className="relative max-w-4xl mx-auto flex flex-col items-center text-center justify-center">
        ...
        <div className="mb-10">
          <Image
            ...
            width={320}
            height={90}
            className="w-[500px] md:w-[700px] h-auto object-contain pb-12"
            priority
          />
        </div>
        ...
        <p className="text-[var(--color-light)] max-w-2xl 
            ...
            <span className="font-bold">
                considered technology selection
            </span>, and{" "}
            <span className="font-bold">
                AI-driven analysis
            </span>, we deliver solutions that reduce operating costs
